...
hs.hotkey.bind({ "cmd" }, "left",  moveWindowLeft50)
hs.hotkey.bind({ "cmd" }, "right",  moveWindowRight50)
hs.hotkey.bind({ "cmd" }, "up",  maximizeCurrentWindow)
hs.hotkey.bind({ "cmd" }, "down",  centerWindow)
